                ...
                <form method="POST" action="{{ route('superadmin.plans.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" value="{{ old('name') }}" placeholder="e.g., Basic, Pro, Enterprise" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                               id="slug" name="slug" value="{{ old('slug') }}" placeholder="e.g., basic, pro, enterprise" required>
                        <div class="form-text">Unique identifier for the plan (lowercase, no spaces)</div>
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
