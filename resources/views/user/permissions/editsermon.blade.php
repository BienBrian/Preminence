    ...
    <div class="row">
        <div class="col-xl-12 mb-5 mb-xl-0">
            <div class="card shadow">
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{url('/editsermon')}}" enctype="multipart/form-data" class="row d-flex align-items-center sermon-form">
                        @csrf
                        ...
                        <div class='form-group col-sm-12'>
                            ...
                            <input name="title" type="text" placeholder="Sermon Title" class="form-control timepicker" value="{{$sermon->title}}"required>
                        </div>
                        <div class='form-group col-sm-6'>
                            <label><small>Date</small></label>
                            <input name="date" type="text" placeholder="Sermon Date" class="form-control datepicker" readonly>
                        </div>
                        <div class='form-group col-sm-6'>
                            <label><small>Youtube Link</small></label>
                            <input name="youtube" type="text" placeholder="Youtube Link" class="form-control" value="{{$sermon->youtube}}">
                        </div>
                        <div class="col-sm-12">
                            <label class='mt-3'><small>Description</small></label>
                            <textarea name="description" placeholder="Sermon Content" rows="5" class="form-control">{{$sermon->description}}</textarea>
