...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-header"><i class='fas fa-chart-pie'></i> View <b>Sold</b> Share</h5>
                </div><!-- /.col -->
                <div class="col-sm-6 text-right">
                    ...
                    @else
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">View Sold Share</li>
                        </ol>
                    @endcan
                </div><!-- /.col -->
            </div><!-- /.row -->
                        ...
                        <div class="card-body">
                            <div class='search-form row d-flex align-items-end'>
                                <div class="col-6 col-sm-3 col-md-3">
                                    ...
                                    INR {{ number_format($share->amount, 2, '.', ',') }}
                                </div>
                                <div class="col-6 col-sm-3 col-md-3">
                                    <label>Balance Amount</label><br>
                                    INR {{ number_format($share->balance, 2, '.', ',') }}
                                </div>
                                ...
                                <div class="col-6 col-sm-3 col-md-2">
                                    ...
                                    <span
                                        class='created_at'>{{ \Carbon\Carbon::parse($share->created_at)->diffForHumans() }}</span>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ url('dashboard/shares/bought/confirm') }}" class="row"
                            ...
                            <div class='alert alert-info'>
                                <table>
                                    <tr>
                                        ...
                                        <td class='p-1'> You can <b>Confirm</b> or <b>Dispute</b> Reciept of <i
                                                class='fas fa-rupee-sign'></i> <b class='amount'>-</b>
                                            by <b class='username'>-</b> by updating the
                                            status below.
                                        </td>
                                    </tr>
                                </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.table .btn-edit', function() {
                ...
                var buyer_id = row.find('.buyer_id').text();
                var share_transaction_id = row.find('.share_transaction_id').text();
                //var screenshot = $('.screenshot').text();
                ...
                var amount = row.find('td:nth-child(3)').text();
