...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-header"><i class='fas fa-money-bill-alt'></i> <b>Sold</b> Shares</h5>
                </div><!-- /.col -->
                <div class="col-sm-6 text-right">
                    ...
                    @else
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Sold Shares</li>
                        </ol>
                    @endcan
                </div><!-- /.col -->
            </div><!-- /.row -->
                        ...
                        <div class="card-body">
                            <form class='search-form row d-flex align-items-end' id='search-form'>
                                ...
                                <div class="col mb-1">
                                    ...
                                    <input type='text' name='date' class='form-control' placeholder="Date" id='date' value='{{ auth()->user()->can("View Sold Shares")?date("Y-m-d"):"" }}'/>
                                    </div>
                                </div>
                            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('.table').DataTable({
                ...
                serverSide: true,
                language: {
                    emptyTable: "<i class='fas fa-ban'></i> No Sold shares available",
                },
                ajax: {
                    url: "{{ url('dashboard/shares/datatable/sold') }}",
                    data: function(d) {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            switch (data) {
                                ...
                                case "Disputed":
                                    return '<span class="text-warning">Disputed</span>';
                                default:
